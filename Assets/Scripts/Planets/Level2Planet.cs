...
public class Level2Planet : PlanetBase {
	...
	void Start () {
		...
		movement.AddClockwiseCircle (this.transform.position + new Vector3 (-15, 0, 0), this.transform.position, Mathf.Deg2Rad * 360f, 10);
